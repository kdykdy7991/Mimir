...
| F3 | 在 Query 链路打点 | [x] | 2026-07-23 | HybridSearch 6 阶段 + RerankerStage 4 事件 trace 注入（method/elapsed_ms/n_in/n_out/fallback） + 14 集成测试 + reranker_fallback 修复 `time` import + 调整 stale `start` 断言 |
