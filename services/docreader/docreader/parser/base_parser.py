...
#
# Basic-migration from WeKnora (MIT, Copyright (C) 2025 Tencent):
#   docreader/parser/base_parser.py @ 3e6010e7cd3937f289cc1dbadc829e71eb1163f4
# Kept interface/functions; adapted package path (docreader.models.document)
# and imports. Chunking/OCR/VLM stay OUT of the parser (handled by the Go/main
# service), matching upstream's refactored intent.
"""Base parser interface (bytes -> service-local Document)."""
