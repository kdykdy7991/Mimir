...
def _common():
    """Resolve after smoke-import tests that deliberately evict modules."""
    return import_module("src.mcp_server.tools.common")
...
def test_bootstrap_in_process_default(tmp_path):
    common = _common(); common.reset_client_cache()
