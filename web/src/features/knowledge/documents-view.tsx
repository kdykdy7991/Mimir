...
async function loadData(fixedCollectionId: string | undefined, signal: AbortSignal, documentCursor?: string): Promise<Data> {
  ...
  for (const document of documents) {
    const identity = document.collection_id + ":" + document.id;
    if (!uniqueDocuments.has(identity)) uniqueDocuments.set(identity, document);
  }
  return { collections, documents: [...uniqueDocuments.values()] };
}
